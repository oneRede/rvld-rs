...
use crate::file_type::{get_file_type, FILE_TYPE_ARCHIVE, FILE_TYPE_OBJECT};
...
#[allow(dead_code)]
fn create_object_file(elf_file: ElfFile) -> ObjectFile<'_> {
